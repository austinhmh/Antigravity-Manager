                    ...
                    {activeTab === 'account' && (
                        <div className="space-y-4 animate-in fade-in duration-500">
                            ...
                            <div className="group bg-white dark:bg-base-100 rounded-xl p-5 border border-gray-100 dark:border-base-200 hover:border-blue-200 transition-all duration-300 shadow-sm">
                                ...
                                {/* Smart Scheduled Refresh Notice */}
                                <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/30 rounded-xl">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="text-xs font-bold text-amber-700 dark:text-amber-400 mb-1.5">{t('settings.account.smart_refresh_title')}</div>
                                            <ul className="text-xs text-amber-600 dark:text-amber-500 space-y-1 list-none">
                                                <li className="flex items-center gap-1.5">
                                                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 flex-shrink-0"></span>
                                                    {t('settings.account.smart_refresh_dense')}
                                                </li>
                                                <li className="flex items-center gap-1.5">
                                                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 flex-shrink-0"></span>
                                                    {t('settings.account.smart_refresh_blocked')}
                                                </li>
                                                <li className="flex items-center gap-1.5">
                                                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 flex-shrink-0"></span>
                                                    {t('settings.account.smart_refresh_normal')}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
